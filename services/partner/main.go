...
const (
	TELCO_KEY_ID        = "PARTNER_KEY_ID"
	TELCO_CLIENT_ID     = "PARTNER_CLIENT_ID"
	TELCO_CLIENT_SECRET = "PARTNER_CLIENT_SECRET"
	TELCO_ISSUER_URL    = "PARTNER_ISSUER_URL"
)

func main() {
	logger := logs.Init("[Partner-Telco]")
